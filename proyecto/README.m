...
1. sudo ./main_ubuntu 100 1 1 1 0.1 1//runtinem[ms] log cpumutex prioinh correctionOffset deadlineTolerance(or main_rpi4)
1. sudo ./main_rpi4   100 1 1 1 2.5 1//runtinem[ms] log cpumutex prioinh correctionOffset deadlineTolerance(or main_rpi4)
